...
# NOTE: removed any reference to tensorflow.python.util.deprecation, imported the only used part below
...
from google.protobuf import messagea

from . import api_objects_pb2, tf_decorator, tf_inspect
    ...
    def __call__(self, path, parent, children):
        ...
        def _AddMember(member_name, member_obj, proto):
            ...
            if _SkipMember(parent, member_name) or isinstance(
                member_obj, HiddenTfApiAttribute
            ):
                return
